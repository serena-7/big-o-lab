...
// ANSWER - countLetters: 1 * 26 + 1 * n ==> O(n)
// ANSWER - countLettersRoundTwo: 1 * n ==> O(n)


// Q: Explain how you came to your conclusions about the space complexity of each function. 
// ANSWER: both have letters. One is a constant amount of space the other is dependent on the amount of letters. The first has a new arr with string.split.
